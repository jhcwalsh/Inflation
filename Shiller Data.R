Home / GitHub / enricoschumann/NMOF / R/market_data.R
R/market_data.R
In enricoschumann/NMOF: Numerical Methods and Optimization in Finance
Defines functions French Shiller
Documented in French Shiller
## -*- truncate-lines: t; -*-
...
dest.dir="/Users/jhcwalsh/Dropbox/R/workspace/Inflation"
shiller<-Shiller(dest.dir,
        url = "http://www.econ.yale.edu/~shiller/data/ie_data.xls")
